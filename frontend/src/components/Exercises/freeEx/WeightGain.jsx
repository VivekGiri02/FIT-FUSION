...
const WeightGain = () => {
  ...
  const workoutPlan = {
    Monday: [
      ...
      { name: "Incline Dumbbell Press", sets: "4 × 10", muscle: "Chest" },
      { name: "Chest Fly", sets: "3 × 12", muscle: "Chest" },
      { name: "Tricep Dips", sets: "3 × 12", muscle: "Triceps" }
    ],
    Tuesday: [
      { name: "Deadlift", sets: "4 × 8", muscle: "Back" },
      { name: "Lat Pulldown", sets: "4 × 10", muscle: "Back" },
      { name: "Barbell Row", sets: "3 × 10", muscle: "Back" },
      { name: "Barbell Curl", sets: "3 × 12", muscle: "Biceps" }
    ],
    Wednesday: [
      { name: "Squats", sets: "4 × 10", muscle: "Legs" },
    ...
    Thursday: [
      { name: "Bench Press", sets: "4 × 10", muscle: "Chest" },
      { name: "Incline Press", sets: "3 × 10", muscle: "Chest" },
      { name: "Cable Fly", sets: "3 × 12", muscle: "Chest" },
    ...
    Saturday: [
      { name: "Squats", sets: "4 × 10", muscle: "Legs" },
      { name: "Leg Press", sets: "3 × 12", muscle: "Legs" },
      { name: "Leg Extension", sets: "3 × 12", muscle: "Legs" },
      { name: "Shoulder Press", sets: "3 × 10", muscle: "Shoulders" }
    ]
  };
      ...
      <div className="max-w-3xl mx-auto">
        <header className="mb-16 text-center">
          ...
          <div className="inline-flex items-center gap-4 border-y border-gray-200 py-3 px-8">
            <span className="text-gray-400 text-sm uppercase tracking-widest">Focus</span>
            <span className="h-1 w-1 bg-gray-300 rounded-full"></span>
            <span className="text-sm font-medium uppercase">Hypertrophy & Strength</span>
          </div>
        </header>
          ...
          {Object.keys(workoutPlan).map((day) => (
            <button
              ...
              className={`pb-4 text-sm uppercase tracking-widest transition-all relative ${
                selectedDay === day ? "text-black font-bold" : "text-gray-400 hover:text-black"
              }`}
            >
              {day}
          ...
          {workoutPlan[selectedDay].map((exercise, index) => (
            <div key={index} className="group py-6 flex justify-between items-center gap-4 hover:translate-x-2 transition-all duration-300">
              ...
              <div className="text-right">
                <span className="text-sm font-serif italic text-gray-500 block mb-1">Volume</span>
